...
pcl_ptr points_to_pcl_old(const rs2::points& points)
{
...
int main(int argc, char * argv[]) try
{
	...
	while (app) // Application still alive?
	{
		...
		//Save frame as PCD file
		std::stringstream ss;
		ss << "/home/shared/tttt/pcl-incremental-regist/build/capture"<<frameCount << ".pcd";
